...
const OutRoom = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                const res = await axios.post("http://192.168.2.82:5000/deleteReadRoom", {
    ...
    const deleteRoom = roomnum => {
        ...
        if (result) {
            axios.post("http://192.168.2.82:5000/deleteRoom", {
                roomNum: roomnum,
                ...
                <th colSpan={4} style={{ backgroundColor: 'white' }}>
                  <div style={{
                    ...
                    <tr >
                        ...
                        <th>{e.roomHost}</th>
                        <th>{e.roomMember}</th>
                        <th><Button variant="outline-secondary" onClick={() => deleteRoom(e.roomNum)}>삭제</Button></th>
                    </tr>
                )
            }
        </tbody>
